...
ax.plot(df.index, df.Upper, label='Upper', color='gray', linestyle='--')
ax.plot(df.index, df.Lower, label='Lower', color='gray', linestyle='--')

# Customize the plot
ax.set_xlabel('Date')
ax.set_ylabel('Price')
ax.set_title('AAPL Stock Price with Bollinger Bands')
ax.legend()
